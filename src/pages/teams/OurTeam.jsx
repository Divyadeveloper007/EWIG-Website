...
const OurTeam = () => {
    ...
    const goToPrevious = () => {
        setCurrentIndex(currentIndex === 0 ? teamMember.length - 1 : currentIndex - 1);
    };

    // Move to the next team member
    const goToNext = () => {
        setCurrentIndex(currentIndex === teamMember.length - 1 ? 0 : currentIndex + 1);
    };
        ...
        <div className="px-4 md:px-10 lg:px-20 py-10 space-y-10">
            ...
            <div className="block lg:hidden relative">
                ...
                <button
                    ...
                    className="absolute left-0 top-1/2 transform -translate-y-1/2 text-white bg-[#0A9642] p-2 rounded-full shadow-lg"
                >
                    &#10094;
                </button>
                ...
                <button
                    onClick={goToNext}
                    className="absolute right-0 top-1/2 transform -translate-y-1/2 text-white bg-[#0A9642] p-2 rounded-full shadow-lg"
                >
                    &#10095;
                </button>
