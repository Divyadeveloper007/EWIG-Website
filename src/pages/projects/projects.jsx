...
const Projects = () => {
  ...
  return (
    <div id="projects" className="min-h-screen flex flex-col items-center justify-center bg-white px-4 py-8">
      {/* Heading */}
      ...
      <div className="relative w-full max-w-5xl pb-24 overflow-hidden">
...
<div className="w-full md:absolute md:top-[23%] md:left-[45%] md:w-[50%] z-10">
  ...
  {project.title}
      ...
      <h2 className="text-2xl font-bold text-[#101828] leading-snug">{project.summary}</h2>
        ...
        <div className="flex justify-center mt-3 md:absolute md:top-[2%] md:right-44 md:transform md:-translate-y-1/2 md:z-10 md:flex-row flex-row gap-4">
          <button
